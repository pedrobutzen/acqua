...
$resultados = mysqli_query($conect, "SELECT l.idlancamento, u.usuario, u.email FROM lancamento as l JOIN(usuario as u) ON(u.usuario=l.usuario) WHERE ISNULL(l.data_devolucao) AND !ISNULL(l.data_recebimento) AND u.sexo='f'");
