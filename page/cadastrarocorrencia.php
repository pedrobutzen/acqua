...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="col-lg-12">
            <h2>Cadastrar Ocorrência <small>Cadastrar ocorrência ligada a peça</small></h2>
            <hr>
            <div class="row-fluid">
                    ...
                    <span id="cs-div-pesquisa">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" id="cs-form">
                                ...
                                <button type="button" data-pagina="usuariocadastrarocorrencia" class="btn btn-primary cs-pesquisar">Pesquisar</button>
