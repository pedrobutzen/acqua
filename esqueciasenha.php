        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-box col-lg-4" id="login-box"> 
                    <div class="info-login">Uma nova senha será enviada para o e-mail do usuário cadastrado no sistema.</div>
                    <div class="form-group">
                        <input type="text" name="usuario" class="form-control" placeholder="Usuário">
                    </div>
                    <button type="button" class="btn btn-block btn-outline cs-esqueciasenha btn-danger">Recuperar Senha</button>
                    <a href="login" class="pull-right">Logar</a>
                </div>
            </div>
        </div>
